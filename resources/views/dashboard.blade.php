		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-2">
					<div class="dashboard-stat-content"><h4>{{Auth::user()->trombosit}}</h4><span>Trombosit (mcL)</span></div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-3">
					<div class="dashboard-stat-content"><h4>{{Auth::user()->hemogoblin}}</h4> <span>Hemogoblin (Gram / DL)</span></div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-4">
					<div class="dashboard-stat-content"><h4>{{Auth::user()->submissions()->where('status','active')->count()}}</h4> <span>Total Mendonor</span></div>
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box invoices with-icons margin-top-20">
					<h4>3 Pengajuan Terakhir</h4>
					<ul>
                        @forelse ($submissions as $sub)
						<li><i class="list-box-icon sl sl-icon-doc"></i>
							<strong>Menjadi Pendonor di {{$sub->place->name}}</strong>
							<ul>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        ...
                        stockList.append('<li>Stock darah sedang kosong</li>');
                    }
                },
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if ($('#stock-list').children().length === 0) {
                    ...
                    $('#stock-list').append('<li>Stock darah sedang kosong</li>');
                }
            },
            error: function(xhr, status, error) {
                // Handle error
