					...
					<form method="POST" action="{{ route('register') }}" class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								...
								<input name="name" placeholder="Nama Lengkap" class="search-field" type="text" value=""/>
                                @error('name')
						...
						<div class="row with-forms">
							<div class="col-md-12">
								...
								<input name="password_confirmation" placeholder="Konfirmasi Password" class="search-field" type="password" value=""/>
